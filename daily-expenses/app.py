...
# Page config
st.set_page_config(page_title="Daily Expense Truth", layout="wide")
...
col4.plotly_chart(fig_plan, use_container_width=True)

# Mood vs Avg Spending
fig_mood = px.bar(
...
st.write("Enter expense details to predict risk level")
